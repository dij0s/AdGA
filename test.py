    ...
    def input(self, key):
        ...
        if key in combo and all([held_keys[e] for e in combo]):
            if not self.recording:
                ...
                #   Following the track of screenshot() called by base
                """
                print(base)
                print(base.win) # https://docs.panda3d.org/1.10/python/reference/panda3d.core.GraphicsOutput#panda3d.core.GraphicsOutput
                print(base.win.getDisplayRegion(0)) # https://docs.panda3d.org/1.10/python/reference/panda3d.core.DisplayRegion#panda3d.core.DisplayRegion
                print("RAM image=", base.win.getDisplayRegion(0).getScreenshot().getRamImage())
                """
                ...
                #   Image arrives with inverted Y axis
                image = image[::-1,:,:]

                print("done in ", time.time() - start)

                import imageio
                imageio.imsave('outimage.png', image)
